...
public class HbaseService {
    ...
    public void insert(String values)  throws IOException {
    	...
    	ticker.setFormattedDateTime(CommonUtils.convertToDateTime(ticker.getTime()));
        ...
        put.addColumn(Bytes.toBytes(COLUMN_FAMILY), Bytes.toBytes("formattedDateTime"), convertToByte(ticker.getFormattedDateTime()));
